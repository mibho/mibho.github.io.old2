...
<h5> Part 2 </h5>
        ...
        <p class="lolwat2"> mov [ebp+eax+ <br>
            FindFileData.cAlternateFileName+6], 0<span class="lolwat"> add 0 at the end of cAlternateFileName [null character to denote end of c-string..?] </span> 
            </p>
