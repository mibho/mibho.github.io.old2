...
<h5> How did I get: </h5>
    ...
    <p style=" font-weight:501; text-align:left; font-size:130%;"> If you're wondering why the stack diagram is "different" from the last drawing in the previous part, it's b/c the last diagram was the stack for FindNextFileA (Part 3). The one I'm referring back to is Part 1 (since it's sub_401030, which we're in right now)  </p>
    ...
    When the zero Flag isn't set, loc_40105D:
    
    <img src="https://user-images.githubusercontent.com/86342821/144725179-0e89b4bb-5504-48d7-88ca-94643fbf4687.png">
