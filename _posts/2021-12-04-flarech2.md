...
<h5> How did I get: </h5>
    ...
    <br> <br>
    if you've come this far, what does the stack look like now? (hint: continue from the diagram of the most recent frame)
...
We can see here that **bl** corresponds to the **user's input** and **al** to the **file data**. Each byte of the file data is XORed with those of the user's input 
