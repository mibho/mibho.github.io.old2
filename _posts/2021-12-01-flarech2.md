...
I'm going to name it (*sub_4011F0*) **maybeDecrypt** and put it to the side for now. There's still some code we haven't looked at and it's possible one of them could be related to solving this problem.
...
Below contains my solution for obtaining the key. Tt's not elegant but it got the job done without any problems.  
...
![image](https://mibho.github.io/images/peepoteethsmile.png) Let's check another file to make sure this wasn't a fluke.
