---
layout: tocpost
title: 'Flare-On8-2021 - Chall 02: known'
categories: [FlareOn8, x86, XOR, circular bit shift, encryption, decryption]
...
Continuing from where we left off earlier, we can see that *sub_4011F0* executes as follows:
...
If I could recap the way I was feeling right after solving this, I think it'd be best expressed by the following reaction:
<yesgif>
